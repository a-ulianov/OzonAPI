...
from ...schemas.fbs import PostingFBSUnfulfilledListV3Request, PostingFBSUnfulfilledListV3Response


class PostingFBSUnfulfilledListV3Mixin(APIManager):
    """Реализует метод /v3/posting/fbs/unfulfilled/list"""

    async def posting_fbs_unfulfilled_list_v3(
        self: "PostingFBSUnfulfilledListV3Mixin",
        ...
        Args:
            request: Запрос на получение информации о необработанных отправлениях FBS и rFBS за указанный период времени по схеме `PostingFBSUnfulfilledListV3Request`

        Returns:
            Список необработанных отправлений за указанный период времени по схеме `PostingFBSUnfulfilledListV3Response`
        ...
        return PostingFBSUnfulfilledListV3Response(**response)
