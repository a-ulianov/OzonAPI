...
from src.ozonapi.seller.common.enumerations.postings import PostingStatus, AvailablePostingActions, PostingSubstatus, \
    TplIntegrationType
from src.ozonapi.seller.common.enumerations.requests import SortingDirection
from src.ozonapi.seller.schemas.fbs import PostingFBSUnfulfilledListV3Response, PostingFBSFilterWith, \
    PostingFBSUnfulfilledListV3Filter, PostingFBSUnfulfilledListV3Request


class TestPostingFBSUnfulfilledListV3:
    """Тесты для метода posting_fbs_unfulfilled_list."""

    @pytest.mark.asyncio
    async def test_posting_fbs_unfulfilled_list_v3(self, api, mock_api_request):
        ...
        request = PostingFBSUnfulfilledListV3Request(
            filter=PostingFBSUnfulfilledListV3Filter(
        ...
        response = await api.posting_fbs_unfulfilled_list_v3(request)
        ...
        assert isinstance(response, PostingFBSUnfulfilledListV3Response)
