...
from src.ozonapi.seller.schemas.fbs import PostingFBSListV3Response


class TestPostingFBSListV3:
    """Тесты для метода posting_fbs_list."""

    @pytest.mark.asyncio
    async def test_posting_fbs_list_v3(self, api, mock_api_request):
        ...
        response = await api.posting_fbs_list_v3(request)
        ...
        assert isinstance(response, PostingFBSListV3Response)
