...
from src.ozonapi.seller.schemas.fbo import PostingFBOListV2Response


class TestPostingFBOListV2:
    """Тесты для метода posting_fbo_list_v2 (устаревший v2)."""

    @pytest.mark.asyncio
    async def test_posting_fbo_list_v2(self, api, mock_api_request):
        """Тестирует метод posting_fbo_list_v2."""
        ...
        from src.ozonapi.seller.schemas.fbo import PostingFBOListV2Request
        ...
        response = await api.posting_fbo_list_v2(request)
        ...
        assert isinstance(response, PostingFBOListV2Response)
