...
from src.ozonapi.seller.schemas.fbo import PostingFBOCancelReasonListResponse


class TestPostingFBOCancelReasonList:
    """Тесты для метода posting_fbo_cancel_reason_list."""

    @pytest.mark.asyncio
    async def test_posting_fbo_cancel_reason_list(self, api, mock_api_request):
        """Тестирует метод posting_fbo_cancel_reason_list."""
        ...
        response = await api.posting_fbo_cancel_reason_list()
        ...
        assert isinstance(response, PostingFBOCancelReasonListResponse)
